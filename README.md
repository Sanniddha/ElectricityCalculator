...
$$\text{Energy generated (in kW)} = "Area of each solar panel" (in m^2) * "No.of solar panels" * "Efficiency of the solar panel(%)" * Monthly avg.solar radiation(in kW/m^2) * Performance ratio$$
